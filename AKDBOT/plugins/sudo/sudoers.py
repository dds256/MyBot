...
from AKDBOT.utils.database import add_sudo, remove_sudo
from AKDBOT.utils.decorators.language import language
from AKDBOT.utils.extraction import extract_user
from AKDBOT.utils.inline import close_markup
...
async def sudoers_list(client, message: Message):
    ...
    await message.reply_video(video="https://graph.org/file/318eac81e3d4667edcb77.mp4", caption="**» ᴄʜᴇᴄᴋ sᴜᴅᴏ ʟɪsᴛ ʙʏ ɢɪᴠᴇɴ ʙᴇʟᴏᴡ ʙᴜᴛᴛᴏɴ.**\n\n**» ɴᴏᴛᴇ:**  ᴏɴʟʏ sᴜᴅᴏ ᴜsᴇʀs ᴄᴀɴ ᴠɪᴇᴡ. ", reply_markup=reply_markups)
